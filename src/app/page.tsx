      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
          ...
          <div className="text-2xl font-extrabold text-slate-900 mt-2">
            C$ {kpis?.ventas_mes_nio.toLocaleString('es-NI', { minimumFractionDigits: 2 })}
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
          ...
          <div className="text-2xl font-extrabold text-indigo-600 mt-2">
            $ {kpis?.ventas_mes_usd.toLocaleString('en-US', { minimumFractionDigits: 2 })}
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
          ...
          <div className="text-2xl font-extrabold text-rose-600 mt-2">
            C$ {kpis?.cartera_cxc_vencida_nio.toLocaleString('es-NI', { minimumFractionDigits: 2 })}
          </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
          ...
          <div className="text-2xl font-extrabold text-amber-600 mt-2">
            C$ {kpis?.iva_neto_estimado_nio.toLocaleString('es-NI', { minimumFractionDigits: 2 })}
          </div>
